...
const COLORS = {
  primary: '#bdff84', // Backbone Neon
  accent: '#655dc6', // Purple
  light: '#400286',
  neutral: '#161616', // Dark
  bgZebra: '#f1f1f1'
};
...
export default function BackboneLayout({ data }: { data: TDSData }) {
  const theme = BRAND_THEMES.backbone;
  ...
  return (
    <Page size="A4" style={[styles.page, { fontFamily: theme.fontFamily }]}>
      ...
      <Footer brand="backbone" borderColor={COLORS.primary} />
    </Page>
  );
}
