...
export default function NuvoLayout({ data }: { data: TDSData }) {
  const theme = BRAND_THEMES.nuvo;
  ...
  return (
    <Page size="A4" style={[styles.page, { fontFamily: theme.fontFamily }]}>
      ...
      <Footer brand="nuvo" borderColor={COLORS.primary} />
    </Page>
  );
}
